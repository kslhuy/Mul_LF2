...
//     {
//         [Tooltip("The StateType this is the data for. An enum that represents the specific action, compared to ActionLogic, where multiple Actions can share the same Logic")]
//         public StateType StateTypeEnum;
