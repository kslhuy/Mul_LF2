...
namespace LF2
{
    ...
    public class CharSelectData : NetworkBehaviour
    {
        ...
        {
            new LobbySeatConfiguration(CharacterTypeEnum.Deep, 0),
            new LobbySeatConfiguration(CharacterTypeEnum.David, 1),
            new LobbySeatConfiguration(CharacterTypeEnum.Dennis, 2),
            new LobbySeatConfiguration(CharacterTypeEnum.Freeze, 3),
            new LobbySeatConfiguration(CharacterTypeEnum.Henry, 4),
            new LobbySeatConfiguration(CharacterTypeEnum.John, 5),
            new LobbySeatConfiguration(CharacterTypeEnum.Firen, 6),
            new LobbySeatConfiguration(CharacterTypeEnum.Woody, 7),
        };

        public const int k_MaxLobbyPlayers = 4;
