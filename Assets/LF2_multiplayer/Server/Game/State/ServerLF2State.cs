...
{
    /// <summary>
    /// Server specialization of core LF2 game logic.
    /// </summary>
    public class ServerLF2State : GameStateBehaviour
    {
        ...
        public LobbyResults.CharSelectChoice GetLobbyResultsForClient(ulong clientId)
        {
            ...
            if (!m_LobbyResults.Choices.TryGetValue(clientId, out returnValue))
            {
                ...
                returnValue = new LobbyResults.CharSelectChoice(-1, CharacterTypeEnum.Deep, 0);
        ...
        private void SpawnPlayer(ulong clientId)
        {
            ...
            // // var physicsTransform = newPlayer.GetComponent<ServerCharacter>.
